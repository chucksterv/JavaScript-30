...
const fifteen = inventors.filter(
  (inventor) => inventor.year >= 1500 && inventor.year < 1600 //return true keeps the values
);
...
const oldest = inventors.sort(function (a, b) {
  ...
  // Same as above in longer form. Look up sort method for more info.
  // if(aInventor > bInventor) {
  //     return -1;
  // } else {
  //     return 1;
  // }
...
//Run in the console in the above link. Grabs the links within a specific class
//Sorts the data
